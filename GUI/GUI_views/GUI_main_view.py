...
class MainWindow(tk.Frame):
    ...
    def display_products_list_view(self, user, sort_by=False, search_by=False):
        self.clear_main_window()
        self.display_top_frame_select_button_view(user)
        self.product_list_view.products_list_view(user, sort_by=sort_by, search_by=search_by)
        self.top_select_view.grid(sticky=tk.W, padx=10)
        self.product_list_view.grid(sticky=tk.W, padx=10)

    def display_shopping_cart_view(self, user, product_sort_by=False, product_search_by=False):
        self.clear_main_window()
        self.display_top_frame_select_button_view(user)
        self.shopping_cart_view.shopping_cart_view(user, product_sort_by, product_search_by)
        self.top_select_view.grid(sticky=tk.W, padx=10)
